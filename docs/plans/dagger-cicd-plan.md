...
- **Agent**: Create `.vscode/mcp.json`:
  ...
  ```
- **Human**: Test in Copilot Chat: `@dagger-docs.searchDocs "cache volumes"`
...
1. Complete all human steps in Sections 4.0, 4.5, and 4.6.
2. Then tell Copilot Chat: “Start working through Section 4.1 of TASKS.md”
